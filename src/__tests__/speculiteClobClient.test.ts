...
describe('SpeculiteClobClient', () => {
  ...
  it('supports v2 resolution, evidence, and challenge endpoints', async () => {
      ...
      .mockResolvedValueOnce(
        jsonResponse({
          ...
          market: {
            ...
            resolutionChainHeadHash: null,
            anchorBundleHash: null,
            finalizedAt: null,
            createdAt: '2026-03-15T00:00:00.000Z',
      ...
      .mockResolvedValueOnce(
        jsonResponse({
          ...
          attestation: {
            ...
            runtimeVersion: 'local-hashed-0.1.0',
            inputHash: 'input-hash',
            outputHash: 'output-hash',
            evidenceBundleHash: 'bundle-hash',
            proposalHash: 'proposal-hash',
            attestationPayload: { runtimeKind: 'LOCAL_HASHED' },
            signature: null,
          ...
          anchorBundle: {
            ...
            marketEnvelope: {
              ...
              marketId: 'market-1',
              canonicalQuestionHash: 'question-hash',
              resolutionSpecHash: 'spec-hash',
              toolCatalogVersion: '2026-03-15.v1',
              toolCatalogHash: 'catalog-hash',
              createdAt: '2026-03-15T00:00:00.000Z',
              envelopeHash: 'market-envelope-hash'
            },
            plannerEnvelopes: [],
            resolutionEnvelopes: [],
            latestPlannerEnvelopeHash: null,
            latestResolutionEnvelopeHash: null,
            chainHeadHash: 'market-envelope-hash',
            anchorBundleHash: 'anchor-bundle-hash',
            onchainAnchorPayload: {
              marketEnvelopeHash: 'market-envelope-hash',
              plannerEnvelopeHash: null,
              resolutionEnvelopeHash: null,
              chainHeadHash: 'market-envelope-hash',
              anchorBundleHash: 'anchor-bundle-hash'
            }
          },
          onchainResolution: {
            marketAddress: '0x000000000000000000000000000000000000beef',
            resolutionTxHash: '0xdef456',
            resolvedOutcome: 'YES',
            resolutionChainHeadHash: 'market-envelope-hash',
            anchorBundleHash: 'anchor-bundle-hash',
            finalizedAt: '2026-03-15T00:00:02.000Z'
          },
          market: {
            marketId: 'market-1',
            question: 'Will BTC be above $120000?',
    ...
    await client.getV2MarketAnchorBundle('market-1');
